...
videos.href = "./videos.html"
videos.innerHTML = "Videos"
videos.classList.add('mob_nav__link')
mobile_nav.appendChild(videos)

const audios = document.createElement('a')
audios.href = "./audios.html"
audios.innerHTML = "Audios"
audios.classList.add('mob_nav__link')
mobile_nav.appendChild(audios)

const images = document.createElement('a')
images.href = "./images.html"
images.innerHTML = "Images"
images.classList.add('mob_nav__link')
mobile_nav.appendChild(images)
